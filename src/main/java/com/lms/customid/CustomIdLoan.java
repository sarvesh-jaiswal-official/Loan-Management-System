...
public class CustomIdLoan implements IdentifierGenerator {


	private static final long serialVersionUID = 1L;
	private static final long INITIAL_VALUE = 400001; // Initial value for the ID
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        synchronized (CustomIdLoan.class) {
