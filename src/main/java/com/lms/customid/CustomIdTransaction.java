...
public class CustomIdTransaction implements IdentifierGenerator {


	private static final long serialVersionUID = 1L;
	private static final long INITIAL_VALUE = 500001; // Initial value for the ID
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        synchronized (CustomIdTransaction.class) {
