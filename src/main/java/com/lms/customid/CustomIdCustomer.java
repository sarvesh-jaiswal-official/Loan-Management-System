...
public class CustomIdCustomer implements IdentifierGenerator {


	private static final long serialVersionUID = 1L;
	private static final long INITIAL_VALUE = 300001; // Initial value for the ID
    ...
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        synchronized (CustomIdCustomer.class) {
